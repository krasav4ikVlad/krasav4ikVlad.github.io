                  ...
                  ?>
                        <article class="article">
                          ...
                          <div class="article__info">
                            ...
                            <div class="article__info__preview"><?php
              ...
              <div class="block__content">
                <div class="articles articles__horizontal">
                  ...
                  <?php 
                    ...
                    $articles = mysqli_query($connection, "SELECT * FROM articles WHERE categories_id = 7 ORDER BY id DESC LIMIT 4");
            ...
            <div class="block">
              ...
              <div class="block__content">
                ...
                <?php 
                    ...
                    $articles = mysqli_query($connection, "SELECT * FROM articles WHERE categories_id = 4 ORDER BY id DESC LIMIT 4");
                        ...
                        <article class="article">
                          ...
                          <div class="article__info">
                            ...
                            <div class="article__info__meta">
                              ...
                              <small>Категория: <a href="/article.php?id=<?php echo $art_cat['id']; ?>"><?php echo $art_cat['title']; ?></a></small>
                            </div>
                            <div class="article__info__preview"><?php
                              echo mb_substr(strip_tags($art['text']), 0, 100, 'utf-8') . ' ...';
                             ?></div>
