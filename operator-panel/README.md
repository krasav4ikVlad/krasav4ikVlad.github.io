...
Роли:
- **operator** — все действия с пользователями, без лимитов по суммам (каждое действие требует причину и пишется в аудит);
- **owner** — то же + просмотр аудит-лога + управление учётками операторов.
