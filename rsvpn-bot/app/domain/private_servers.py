...
# Почему закрылся сервер, когда списание приостановлено нами. Формулировка
# одна на всех: она попадает и в сообщение владельцу, и в карточку сервера,
# и в уведомление админам «можно гасить VPS».
NO_RENEWAL = 'оплаченный срок закончился, продления больше нет'
