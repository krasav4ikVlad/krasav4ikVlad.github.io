    ...
    Group('raffle', f'{e("gift")} Розыгрыш', (
        ...
        Setting('raffle.end', 'Конец акции', 'str', '',
                hint='ДД.ММ.ГГГГ включительно: оплата в 23:50 последнего дня '
                     'ещё в зачёте'),
        Setting('raffle.min_payment', 'Минимальная оплата друга', 'int', 199,
                unit='₽', min=0,
                hint='Сколько друг должен заплатить настоящими деньгами за '
                     'период, чтобы дать билет. Ставить 0 не стоит: билет за '
                     'бесплатную регистрацию накручивается пачками'),
