...
SCHEMA: tuple[Group, ...] = (
    ...
    Group('private', f'{e("servers")} Личные серверы', (
        ...
        Setting('private.price_share', 'Доля (6 мест)', 'int', 390, unit='₽', min=0),
        ...
        Setting('private.note', 'Подпись на витрине', 'text',
                ...
                'В «Доле» машину делят три владельца, но места, приглашения '
                'и статистика у каждого свои — соседей не видно.'),
    )),
