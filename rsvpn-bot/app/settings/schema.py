...
SCHEMA: tuple[Group, ...] = (
    ...
    Group('raffle', f'{e("gift")} Розыгрыш', (
        ...
        Setting('raffle.win_text', 'Письмо победителю', 'text',
                'Поздравляем! Вы выиграли в розыгрыше RS VPN.',
                hint='Уходит каждому, кому выдали приз командой /rafflewin. '
                     'Сам приз бот допишет строкой ниже'),
