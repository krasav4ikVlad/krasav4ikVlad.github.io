    ...
    Group('private', f'{e("private")} Личные серверы', (
        ...
        Setting('private.enabled', 'Приём заявок', 'bool', True,
                hint='Выключает покупку, не трогая уже работающие серверы. '
                     ...
                     'кнопкой в /queue'),
        Setting('private.autocharge', 'Списывать за серверы ежемесячно',
                'bool', True,
                hint='Выключено — бот не берёт с владельцев ни рубля и '
                     'никого не приостанавливает за неуплату: серверы '
                     'работают дальше, пока вы не закроете их руками. '
                     'Предупреждения о списании тоже не уходят — обещать '
                     'списание и не списать хуже, чем промолчать'),
