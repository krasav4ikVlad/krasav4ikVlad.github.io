...
SCHEMA: tuple[Group, ...] = (
    ...
    Group('bypass', f'{e("bypass")} ByPass (белые списки)', (
        ...
        Setting('bypass.cost_per_gb', 'Себестоимость гигабайта', 'float', 0.0,
                unit='₽', min=0,
                hint='Во сколько гигабайт трафика обходится вам у хостера. '
                     'Нужна одному отчёту — /bypassplan, где считается цена '
                     'безлимитного тарифа. 0 — расход не считается, видна '
                     'только выручка'),
