...
EMOJI: dict[str, tuple[str, str]] = {
    ...
    # Значок-заглушка — цифра в рамке: у «плюс один» своего символа в юникоде
    # нет, а нужен разный на каждое число (иначе не отличить, какой кастомный
    # эмодзи подставлять). Пропишите сюда свои id «+1»…«+5».
    'plus1':          ('1️⃣', ''),
    'plus2':          ('2️⃣', ''),
    'plus3':          ('3️⃣', ''),
    'plus4':          ('4️⃣', ''),
